...
C  
C FOR PROCESS : e- e+ -> t t~ g  
C  
C Crossing   1 is e- e+ -> t t~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=EMEP_TTBG(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION EMEP_TTBG(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,1   ),W(1,2   ),GAL ,ZERO    ,ZERO    ,W(1,6   ))    
      CALL FVIXXX(W(1,4   ),W(1,6   ),GAU ,TMASS   ,TWIDTH  ,W(1,7   ))    
      CALL IOVXXX(W(1,7   ),W(1,3   ),W(1,5   ),GG ,AMP(1   ))             
      CALL JIOXXX(W(1,1   ),W(1,2   ),GZL ,ZMASS   ,ZWIDTH  ,W(1,8   ))    
      CALL FVIXXX(W(1,4   ),W(1,8   ),GZU ,TMASS   ,TWIDTH  ,W(1,9   ))    
      CALL IOVXXX(W(1,9   ),W(1,3   ),W(1,5   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,3   ),W(1,6   ),GAU ,TMASS   ,TWIDTH  ,W(1,10  ))    
      CALL IOVXXX(W(1,4   ),W(1,10  ),W(1,5   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,3   ),W(1,8   ),GZU ,TMASS   ,TWIDTH  ,W(1,11  ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          EMEP_TTBG =EMEP_TTBG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
