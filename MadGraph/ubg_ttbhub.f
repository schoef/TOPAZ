...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=UBG_TTBHUB(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION UBG_TTBHUB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     15  ))                                                          
      ...
      CALL FVIXXX(W(1,6   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      ...
      CALL JIOXXX(W(1,6   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          UBG_TTBHUB =UBG_TTBHUB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
