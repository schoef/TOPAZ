...
C  
C FOR PROCESS : e- e+ -> t t~  
C  
C Crossing   1 is e- e+ -> t t~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION EMEP_TTB(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,1   ),W(1,2   ),GAL ,ZERO    ,ZERO    ,W(1,5   ))    
      CALL IOVXXX(W(1,4   ),W(1,3   ),W(1,5   ),GAU ,AMP(1   ))            
      CALL JIOXXX(W(1,1   ),W(1,2   ),GZL ,ZMASS   ,ZWIDTH  ,W(1,6   ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          EMEP_TTB =EMEP_TTB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
