...
C  
C FOR PROCESS : g g -> t t~ h  
C  
C Crossing   1 is g g -> t t~ h  
      IMPLICIT NONE
C  
C CONSTANTS
C  
      INTEGER    NEXTERNAL,   NCOMB,     NCROSS         
      PARAMETER (NEXTERNAL=5, NCOMB= 16, NCROSS=  1)
      INTEGER    THEL
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION GG_TTBH(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     7   ))                                                          
      ...
      CALL IOSXXX(W(1,4   ),W(1,9   ),W(1,5   ),GHTOP ,AMP(2   ))          
      CALL IOSXXX(W(1,6   ),W(1,8   ),W(1,5   ),GHTOP ,AMP(3   ))          
      ...
      CALL IOSXXX(W(1,4   ),W(1,12  ),W(1,5   ),GHTOP ,AMP(5   ))          
      CALL IOSXXX(W(1,10  ),W(1,11  ),W(1,5   ),GHTOP ,AMP(6   ))          
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,13  ))      
      CALL FVIXXX(W(1,4   ),W(1,13  ),GG ,TMASS   ,TWIDTH  ,W(1,14  ))     
      CALL IOSXXX(W(1,14  ),W(1,3   ),W(1,5   ),GHTOP ,AMP(7   ))          
      CALL FVOXXX(W(1,3   ),W(1,13  ),GG ,TMASS   ,TWIDTH  ,W(1,15  ))     
      CALL IOSXXX(W(1,4   ),W(1,15  ),W(1,5   ),GHTOP ,AMP(8   ))          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          GG_TTBH =GG_TTBH+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
