...
!    BornAmps(24)%ExtLine = (/1,2,6, 5, 4, 3/)
   ...
   BornAmps( 1)%ExtLine = (/3, 4, 5, 6, 1, 2/)
   BornAmps( 2)%ExtLine = (/3, 4, 6, 5, 1, 2/)
   BornAmps( 3)%ExtLine = (/3, 5, 4, 6, 1, 2/)
   BornAmps( 4)%ExtLine = (/3, 5, 6, 4, 1, 2/)
   BornAmps( 5)%ExtLine = (/3, 6, 4, 5, 1, 2/)
   BornAmps( 6)%ExtLine = (/3, 6, 5, 4, 1, 2/)
   BornAmps( 7)%ExtLine = (/3, 5, 6, 1, 2, 4/)
   BornAmps( 8)%ExtLine = (/3, 6, 5, 1, 2, 4/)
   BornAmps( 9)%ExtLine = (/3, 6, 1, 2, 4, 5/)
   BornAmps(10)%ExtLine = (/3, 1, 2, 4, 5, 6/)
   BornAmps(11)%ExtLine = (/3, 5, 1, 2, 4, 6/)
   BornAmps(12)%ExtLine = (/3, 1, 2, 4, 6, 5/)
   BornAmps(13)%ExtLine = (/3, 4, 6, 1, 2, 5/)
   BornAmps(14)%ExtLine = (/3, 6, 4, 1, 2, 5/)
   BornAmps(15)%ExtLine = (/3, 6, 1, 2, 5, 4/)
   BornAmps(16)%ExtLine = (/3, 1, 2, 5, 4, 6/)
   BornAmps(17)%ExtLine = (/3, 4, 1, 2, 5, 6/)
   BornAmps(18)%ExtLine = (/3, 1, 2, 5, 6, 4/)
   BornAmps(19)%ExtLine = (/3, 4, 5, 1, 2, 6/)
   BornAmps(20)%ExtLine = (/3, 5, 4, 1, 2, 6/)
   BornAmps(21)%ExtLine = (/3, 5, 1, 2, 6, 4/)
   BornAmps(22)%ExtLine = (/3, 1, 2, 6, 4, 5/)
   BornAmps(23)%ExtLine = (/3, 4, 1, 2, 6, 5/)
   BornAmps(24)%ExtLine = (/3, 1, 2, 6, 5, 4/)

   PrimAmps( 1)%ExtLine = BornAmps( 1)%ExtLine
   PrimAmps( 2)%ExtLine = BornAmps( 2)%ExtLine
   PrimAmps( 3)%ExtLine = BornAmps( 3)%ExtLine
   PrimAmps( 4)%ExtLine = BornAmps( 4)%ExtLine
   PrimAmps( 5)%ExtLine = BornAmps( 5)%ExtLine
   PrimAmps( 6)%ExtLine = BornAmps( 6)%ExtLine
   PrimAmps( 7)%ExtLine = BornAmps( 7)%ExtLine
   PrimAmps( 8)%ExtLine = BornAmps( 8)%ExtLine
   PrimAmps( 9)%ExtLine = BornAmps( 9)%ExtLine
   PrimAmps(10)%ExtLine = BornAmps(10)%ExtLine
   PrimAmps(11)%ExtLine = BornAmps(11)%ExtLine
   PrimAmps(12)%ExtLine = BornAmps(12)%ExtLine
   PrimAmps(13)%ExtLine = BornAmps(13)%ExtLine
   PrimAmps(14)%ExtLine = BornAmps(14)%ExtLine
   PrimAmps(15)%ExtLine = BornAmps(15)%ExtLine
   PrimAmps(16)%ExtLine = BornAmps(16)%ExtLine
   PrimAmps(17)%ExtLine = BornAmps(17)%ExtLine
   PrimAmps(18)%ExtLine = BornAmps(18)%ExtLine
   PrimAmps(19)%ExtLine = BornAmps(19)%ExtLine
   PrimAmps(20)%ExtLine = BornAmps(20)%ExtLine
   PrimAmps(21)%ExtLine = BornAmps(21)%ExtLine
   PrimAmps(22)%ExtLine = BornAmps(22)%ExtLine
   PrimAmps(23)%ExtLine = BornAmps(23)%ExtLine
   PrimAmps(24)%ExtLine = BornAmps(24)%ExtLine
   ENDIF
