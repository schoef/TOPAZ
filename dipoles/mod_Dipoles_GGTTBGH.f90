! ! this is the file to subtract dipoles for ttggg+H amplitudes
      module ModDipoles_GGTTBGH
      use ModAmplitudes
      use ModProcess
      use ModParameters
      use ModMisc
...
!          do i2 = -1,Nmax(2),N2Jump! Z boson
   ...
   if( TTBH_SpeedUp .and. hel(4).eq.-1 ) cycle
...
!    endif
   ...
   if( TTBH_SpeedUp ) POL1(-i1,:)= PolExt1(1:4)
   endif
