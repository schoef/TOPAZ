...
public:: EvalIntDipoles_QQBTTBGH
...
!-----------------------------------------------------------
      ...
      subroutine EvalIntDipoles_QQBTTBGH(p,MomDK,z,npdf,res)
      use ModIntDipoles
      use ModAmplitudes
      implicit none
      ...
      complex(dp) :: AM(1:2,1:2,1:2),propZ,MZ_Inv,propP
