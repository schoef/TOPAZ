! this is the file to subtract dipoles for qg->tt+q+H amplitudes
      module ModDipoles_QGTTBQH
      use ModAmplitudes
      use ModProcess
      use ModParameters
      use ModMisc
...
!-------------------------------------------------, the other for 'dn' quarks
      ...
      subroutine EvalDipoles_QGTTBQH(p,yRnDk1,Wgt,npdf1,sum_dip)
