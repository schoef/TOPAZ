module ModIntDipoles_QBGTTBQBP_anom
use ModParameters
use ModProcess
use ModMisc
implicit none
...
public:: EvalIntDipoles_QBGTTBQBP_anom
...
!-----------------------------------------------------------
      ...
      subroutine EvalIntDipoles_QBGTTBQBP_anom(p,MomDK,z,npdf,res)
      use ModIntDipoles
      use ModAmplitudes
      use ModZDecay
      implicit none
      ...
      if( npdf.eq.2 ) then
       ...
       if( first_time1 ) then
             ...
             call InitProcess_TbTGGP_anom(ExtParticles1(1:5))
...
!-- ---- NEXT DIPOLE
      AM = (zero,zero) ! first, the ``amplitude matrix'' is set to zero
       ...
       if( first_time2 ) then
             ...
             call InitProcess_TbTQbQP_anom(ExtParticles2(1:5))
