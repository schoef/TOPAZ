! this is the file to subtract dipoles for qq->tt+g+gamma amplitudes
      module ModDipoles_QBGTTBQBP_anom
      use ModAmplitudes
      use ModProcess
      use ModParameters
      use ModMisc
      ...
      public :: EvalDipoles_QBGTTBQBP_anom
...
!-------------------------------------------------, the other for 'dn' quarks
      ...
      subroutine EvalDipoles_QBGTTBQBP_anom(p,yRnDk1,Wgt,npdf1,sum_dip)
...
!      dipole subroutines
       ...
       if( first_time ) then
             ...
             call InitProcess_TbTGGP_anom(ExtParticles(1:5))
...
!------- fill in histograms
       ...
       if( first_time ) then
             ...
             call InitProcess_TbTQbQP_anom(ExtParticles(1:5))
             TreeAmpsDip(1)%PartRef(1:5) = (/1,5,2,3,4/)
...
SUBROUTINE InitProcess_TbTGGP_anom(ExtParticles)
use ModProcess
implicit none
...
RETURN
END SUBROUTINE InitProcess_TbTGGP_anom
...
SUBROUTINE InitProcess_TbTQbQP_anom(ExtParticles)
use ModProcess
implicit none
type(Particle) :: ExtParticles(:)
