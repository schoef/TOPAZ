! this is the file to subtract dipoles for qqb->tt+g+H amplitudes
      module ModDipoles_QQBTTBGH
      use ModAmplitudes
      use ModProcess
      use ModParameters
      use ModMisc
...
!  We label things as 0-> bar t(p1)+ H(p2) + t(p3) + qb(p4)+q(p5)+g(p6)
...
!-------------------------------------------------, the other for 'dn' quarks
      ...
      subroutine EvalDipoles_QQBTTBGH(p,yRnDk1,Wgt,npdf1,sum_dip)
