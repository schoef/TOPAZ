...
!     outgoing convention:
!     bar t = 1, H =2, t=3 ,  incoming glue=4,
!     5=incoming glue
!-----------------------------------------------------------

      subroutine EvalIntDipoles_GGTTBGH(p,MomDK,z,res)
      use ModIntDipoles
      use ModAmplitudes
      implicit none
...
! spin & color avg., color convention adjustment
      mtrsq = mtrsq * alpha_s4Pi**2 /4d0/64d0
